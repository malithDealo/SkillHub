document.addEventListener('DOMContentLoaded', () => {
    ...
    const validateInput = () => {
        ...
        if (!passwordInput.value.trim()) {
            ...
            passwordInput.style.borderColor = '#4CAF50'; /* Green theme */
        }
    };
        ...
        setTimeout(() => {
            ...
            if (mockResponse.success) {
                ...
                if (rememberMeCheckbox.checked) {
                    ...
                    localStorage.setItem('sponsorPassword', password); // Note: Insecure for production
                } else {
                    localStorage.removeItem('sponsorEmail');
                    localStorage.removeItem('sponsorPassword');
                }

                // Show success alert
                alert('Login successful! Redirecting to sponsor dashboard...');
                // window.location.href = '/sponsor-dashboard.html'; // Uncomment for actual redirect
            } else {
    ...
    const savedPassword = localStorage.getItem('sponsorPassword');
