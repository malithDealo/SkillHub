document.addEventListener('DOMContentLoaded', () => {
        ...
        setTimeout(() => {
            ...
            if (mockResponse.success) {
                ...
                if (rememberMeCheckbox.checked) {
                    ...
                    localStorage.setItem('learnerPassword', password); // Note: Insecure for production
                } else {
                    localStorage.removeItem('learnerEmail');
                    localStorage.removeItem('learnerPassword');
                }
    ...
    const savedPassword = localStorage.getItem('learnerPassword');
